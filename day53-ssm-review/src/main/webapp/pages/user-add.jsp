...
<head>
    ...
    <!-- 页面meta /-->
    <script src="${pageContext.request.contextPath}/plugins/jQuery/jquery-3.3.1.js"></script>
    <script src="${pageContext.request.contextPath}/js/vue.js"></script>
    <script src="${pageContext.request.contextPath}/js/axios-0.19.0.js"></script>
