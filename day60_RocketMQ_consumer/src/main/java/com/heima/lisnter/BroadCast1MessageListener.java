...
// messageModel = MessageModel.BROADCASTING 接收广播消息
@Component
@RocketMQMessageListener(topic = "topic_broadcast",consumerGroup ="group5",messageModel = MessageModel.BROADCASTING)
public class BroadCast1MessageListener implements RocketMQListener<String> {

    //这个方法的触发时机： 一旦监听到队列里面消息，就会触发该方法
    @Override
    public void onMessage(String message) {
        System.out.println("广播消息监听者1："+message);
    }
}
